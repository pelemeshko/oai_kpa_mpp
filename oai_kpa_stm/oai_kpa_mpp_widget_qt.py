...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cycle_window_.setMinimumSize(QtCore.QSize(75, 25))
        ...
        self.horizontalLayout_5.addWidget(self.cycle_window_)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_22.setText(_translate("Form", "Длительность воздействия, с"))
